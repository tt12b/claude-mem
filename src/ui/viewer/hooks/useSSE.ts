...
import { Observation, Summary, UserPrompt, AssistantMessage, StreamEvent } from '../types';
    ...
    const connect = () => {
      ...
      eventSource.onmessage = (event) => {
        ...
        switch (data.type) {
          ...
          case 'new_message':
            if (data.message) {
              console.log('[SSE] New assistant message:', data.message.id);
              addProjectIfNew(data.message.project);
